...
`],{type:`text/plain;charset=utf-8;`}),t=URL.createObjectURL(e),n=document.createElement(`a`);n.href=t,n.download=`run_geochronr_bacon.R`,n.click(),URL.revokeObjectURL(t)}loadSampleImage(e){let t=new Image;t.crossOrigin=`anonymous`,t.onload=()=>{this.bgImage=t,this.canvas&&(this.canvas.width=t.naturalWidth,this.canvas.height=t.naturalHeight,this.canvas.style.display=`block`);let n=this.modalEl?.querySelector(`#ad-empty-drop-zone`);n&&(n.style.display=`none`);let r=this.modalEl?.querySelector(`#ad-current-source-label`);r&&(r.textContent=`范例: ${e.toUpperCase()}`),this.inspectionData=null,this.renderCanvas()},t.src=`/image/agedepth?sample=${e}&t=${Date.now()}`}handleCustomImageFile(e){let t=new FileReader;t.onload=t=>{let n=t.target?.result,r=new Image;r.onload=()=>{this.bgImage=r,this.canvas&&(this.canvas.width=r.naturalWidth,this.canvas.height=r.naturalHeight,this.canvas.style.display=`block`);let t=this.modalEl?.querySelector(`#ad-empty-drop-zone`);t&&(t.style.display=`none`);let n=this.modalEl?.querySelector(`#ad-current-source-label`);n&&(n.textContent=e.name),this.inspectionData=null,this.renderCanvas()},r.src=n},t.readAsDataURL(e)}async executeExtraction(){if(!this.modalEl||!this.bgImage)return;let e=parseFloat(this.modalEl.querySelector(`#ad-inp-depth-top`).value)||0,t=parseFloat(this.modalEl.querySelector(`#ad-inp-depth-bottom`).value)||150,n=parseFloat(this.modalEl.querySelector(`#ad-inp-age-left`).value)||3e3,r=parseFloat(this.modalEl.querySelector(`#ad-inp-age-right`).value)||0,i=this.bgImage.naturalWidth,a=this.bgImage.naturalHeight,o=await this.rpcClient.call(`agedepth.extractAndInspect`,{depth_px:[a*.04,a*.88],depth_vals:[e,t],age_px:[i*.13,i*.94],age_vals:[n,r],roi_box:[i*.11,a*.035,i*.96,a*.89],curve_type:`median`,envelope_type:`95_hpd`,depth_unit:`cm`,age_unit:`cal BP`,cal_curve:`IntCal20`});if(o&&o.inspection){this.inspectionData=o.inspection,this.mappedSamples=o.mapped_samples||null,this.renderCanvas(),this.updateMappingTable();let e=this.modalEl.querySelector(`#ad-status-msg`);e&&(e.textContent=`✅ 识别成功！已叠加高精度拟合线与置信带`)}}renderCanvas(){if(!this.canvas||!this.ctx||!this.bgImage)return;let e=this.ctx,t=this.canvas.width,n=this.canvas.height;if(e.clearRect(0,0,t,n),e.drawImage(this.bgImage,0,0,t,n),!this.inspectionData||!this.inspectionData.px_points)return;let r=this.inspectionData.px_points;if(e.save(),e.globalAlpha=this.overlayOpacity,this.showEnvelope&&r.y&&r.x_min&&r.x_max){e.beginPath(),e.moveTo(r.x_min[0],r.y[0]);for(let t=1;t<r.y.length;t++)e.lineTo(r.x_min[t],r.y[t]);for(let t=r.y.length-1;t>=0;t--)e.lineTo(r.x_max[t],r.y[t]);e.closePath(),e.fillStyle=`rgba(245, 158, 11, 0.45)`,e.fill(),e.strokeStyle=`#f59e0b`,e.lineWidth=1.5,e.stroke()}if(this.showCurve&&r.y&&r.x_curve){e.beginPath(),e.moveTo(r.x_curve[0],r.y[0]);for(let t=1;t<r.y.length;t++)e.lineTo(r.x_curve[t],r.y[t]);e.strokeStyle=`#38bdf8`,e.lineWidth=2.5,e.stroke()}if(this.showPollenHorizons&&this.pollenData&&this.pollenData.calibration){let t=this.pollenData.calibration.depthTopValue,i=this.pollenData.calibration.depthBottomValue,a=i-t;a>0&&r.y&&r.x_curve&&(e.fillStyle=`#34d399`,e.strokeStyle=`#059669`,e.lineWidth=1.5,(this.pollenData.calibration.customDepths||[t,(t+i)/2,i]).forEach(i=>{let o=(i-t)/a,s=n*.04+n*.84*o,c=0,l=9999;for(let e=0;e<r.y.length;e++){let t=Math.abs(r.y[e]-s);t<l&&(l=t,c=e)}if(l<25){let t=r.x_curve[c];e.beginPath(),e.arc(t,s,3.5,0,Math.PI*2),e.fill(),e.stroke()}}))}e.restore()}updateMappingTable(){if(!this.modalEl||!this.inspectionData)return;let e=this.modalEl.querySelector(`#ad-mapping-tbody`);if(!e)return;if(e.innerHTML=``,this.mappedSamples&&this.mappedSamples.depths&&this.mappedSamples.depths.length>0){let t=this.mappedSamples;for(let n=0;n<t.depths.length;n++){let r=document.createElement(`tr`),i=t.age_min?t.age_min[n]:t.age_est[n]-100,a=t.age_max?t.age_max[n]:t.age_est[n]+100;r.innerHTML=`
          ...
          <div style="background: var(--bg-tertiary); border: 1px solid var(--border-light); border-radius: 6px; padding: 10px 14px; display: flex; flex-wrap: wrap; gap: 12px; align-items: center; justify-content: space-between;">
            <div style="display: flex; align-items: center; gap: 10px; font-size: 11px;">
              ...
              <div style="display: flex; align-items: center; gap: 4px;">
                ...
                <input type="number" id="ocr-inp-x0" value="${r}" style="width: 60px; font-size: 11px;" />
                <span>~</span>
                <input type="number" id="ocr-inp-x1" value="${i}" style="width: 60px; font-size: 11px;" />
              </div>
              <div style="display: flex; align-items: center; gap: 4px;">
                <span style="color: var(--text-muted);">Y:</span>
                <input type="number" id="ocr-inp-y0" value="${t}" style="width: 60px; font-size: 11px;" />
                <span>~</span>
                <input type="number" id="ocr-inp-y1" value="${n}" style="width: 60px; font-size: 11px;" />
              </div>
            </div>
    ...
    `,this.container.appendChild(a),this.modalEl=a,a.querySelector(`#ocr-close-btn`)?.addEventListener(`click`,()=>this.close()),a.querySelector(`#ocr-btn-cancel`)?.addEventListener(`click`,()=>this.close()),a.querySelector(`#btn-ocr-accept-all`)?.addEventListener(`click`,()=>this.handleBatchAccept(!0)),a.querySelector(`#btn-ocr-skip-all`)?.addEventListener(`click`,()=>this.handleBatchAccept(!1)),a.querySelector(`#btn-ocr-rerun`)?.addEventListener(`click`,()=>this.runOcrRecognition()),a.querySelectorAll(`.ad-btn-angle`).forEach(e=>{e.addEventListener(`click`,()=>{a.querySelectorAll(`.ad-btn-angle`).forEach(e=>{e.style.borderColor=``,e.style.color=``}),e.style.borderColor=`#38bdf8`,e.style.color=`#38bdf8`;let t=parseFloat(e.getAttribute(`data-angle`)||`45`);this.currentAngleDeg=t;let n=a.querySelector(`#ocr-rng-angle`),r=a.querySelector(`#ocr-val-angle`);n&&(n.value=String(t)),r&&(r.textContent=`${t}°`),this.runOcrRecognition()})});let o=a.querySelector(`#ocr-rng-angle`);o?.addEventListener(`input`,()=>{let e=parseFloat(o.value);this.currentAngleDeg=e;let t=a.querySelector(`#ocr-val-angle`);t&&(t.textContent=`${e}°`)}),o?.addEventListener(`change`,()=>{this.runOcrRecognition()}),a.querySelector(`#ocr-btn-apply`)?.addEventListener(`click`,()=>this.applyToDiagramColumns()),await this.runOcrRecognition()}close(){this.modalEl&&=(this.modalEl.remove(),null)}async runOcrRecognition(){if(!this.modalEl)return;let e=this.modalEl.querySelector(`#ocr-summary-tbody`);e&&(e.innerHTML=`<tr><td colspan="6" style="text-align: center; color: #38bdf8; padding: 24px;">⏳ 正在以 ${this.currentAngleDeg}° 倾角仿射扶正并执行高精度 PP-OCRv4 识别与 500+ 植物学词典匹配...</td></tr>`);let t=parseFloat(this.modalEl.querySelector(`#ocr-inp-x0`)?.value)||315,n=parseFloat(this.modalEl.querySelector(`#ocr-inp-x1`)?.value)||1946,r=parseFloat(this.modalEl.querySelector(`#ocr-inp-y0`)?.value)||200,i=parseFloat(this.modalEl.querySelector(`#ocr-inp-y1`)?.value)||510;try{let e=await this.rpcClient.call(`ocr.recognizeLabels`,{label_row_bbox:[t,r,n,i],angle_deg:this.currentAngleDeg});if(e&&e.success&&e.data)this.ocrResult=e.data,this.ocrResult.labels.forEach(e=>{e.accepted=e.status!==`unrecognized`,e.user_override_name=e.suggested_name}),this.renderStripImage(),this.renderSummaryTable(),this.updateStats();else throw Error(`未识别到有效标签数据`)}catch(t){e&&(e.innerHTML=`<tr><td colspan="6" style="text-align: center; color: #ef4444; padding: 24px;">❌ 识别失败: ${t.message||t}</td></tr>`)}}renderStripImage(){if(!this.modalEl||!this.ocrResult)return;let e=this.modalEl.querySelector(`#ocr-strip-img`),t=this.modalEl.querySelector(`#ocr-strip-meta`);if(e&&this.ocrResult.label_row_image&&(e.src=this.ocrResult.label_row_image,e.onload=()=>{this.renderSvgOverlay()}),t){let e=this.ocrResult.label_row_bbox;t.textContent=`范围: [X:${e[0]}~${e[2]}, Y:${e[1]}~${e[3]}] (共识别到 ${this.ocrResult.labels.length} 个属种标注)`}}renderSvgOverlay(){if(!this.modalEl||!this.ocrResult)return;let e=this.modalEl.querySelector(`#ocr-strip-overlay`),t=this.modalEl.querySelector(`#ocr-strip-img`);if(!e||!t)return;e.innerHTML=``;let n=t.naturalWidth||1,r=t.naturalHeight||1;e.setAttribute(`viewBox`,`0 0 ${n} ${r}`);let i=this.ocrResult.label_row_bbox,a=i[0],o=i[1];this.ocrResult.labels.forEach(t=>{let n=document.createElementNS(`http://www.w3.org/2000/svg`,`polygon`),r=t.bbox.map(([e,t])=>`${e-a},${t-o}`).join(` `);n.setAttribute(`points`,r),n.setAttribute(`id`,`svg-box-${t.id}`),n.setAttribute(`fill`,t.id===this.activeHoverId?`rgba(56, 189, 248, 0.45)`:`rgba(56, 189, 248, 0.12)`),n.setAttribute(`stroke`,t.id===this.activeHoverId?`#38bdf8`:`rgba(56, 189, 248, 0.6)`),n.setAttribute(`stroke-width`,t.id===this.activeHoverId?`2.5`:`1.2`),n.style.pointerEvents=`all`,n.style.cursor=`pointer`,n.addEventListener(`mouseenter`,()=>this.setHoverHighlight(t.id)),n.addEventListener(`mouseleave`,()=>this.setHoverHighlight(null)),e.appendChild(n)})}renderSummaryTable(){if(!this.modalEl||!this.ocrResult)return;let e=this.modalEl.querySelector(`#ocr-summary-tbody`);e&&(e.innerHTML=``,this.ocrResult.labels.forEach(t=>{let n=document.createElement(`tr`);n.id=`table-row-${t.id}`,n.style.cursor=`pointer`;let r=`✅ <span style="color:#34d399;font-size:10.5px;">自动</span>`;t.status===`confirm`?r=`⚠️ <span style="color:#f59e0b;font-size:10.5px;">待确认</span>`:t.status===`unrecognized`&&(r=`❌ <span style="color:#ef4444;font-size:10.5px;">未识别</span>`);let i=t.associated_column_name?`<strong style="color:#38bdf8;">${t.associated_column_name}</strong> (X:${Math.round(t.anchor_x)})`:`<span style="color:#64748b;">未吸附</span>`;n.innerHTML=`
...
//# sourceMappingURL=index-DGiDCCXd.js.map