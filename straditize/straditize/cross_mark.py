...
class CrossMarks(object):
    ...
    @docstrings.dedent
    def __init__(self, pos=(0, 0), ax=None, selectable=None,
                 draggable=None, idx_h=None, idx_v=None,
                 xlim=None, ylim=None, select_props=None,
                 auto_hide=False, connected_artists=None, lock=True,
    ...
    def is_selected_by(self, event, buttons=None):
        ...
        buttons = [1] if buttons is None else buttons
